...
import { mutableHandler, readonlyHandler, shallowReadonlyHandler, shallowReactiveHandler } from "./baseHandlers";
...
export function shallowReactive<T extends object>(target: object) {
